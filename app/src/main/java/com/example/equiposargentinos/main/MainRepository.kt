...
class MainRepository() {
    ...
    fun parseTeamResult(fbJsonResponse: FbJsonResponse): MutableList<Team> {
        ...
        for (team in teams){
            ...
            fbList.add(Team(teamId, nombre, teamAbrv, stadiumName, stadiumImg, stadiumLoc, stadiumCap, teamWebsite,teamBadge))
        }
